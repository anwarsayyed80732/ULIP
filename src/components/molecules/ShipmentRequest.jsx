...
export default function ShipmentRequest() {
  ...
  return (
    <div className="m-5 p-4 min-h-[10vh] min-w-[50vw] md:min-w-[70vw]  bg-background-secondary rounded-xl ">
      <form onSubmit={onSubmit} className="flex flex-col md:flex-row md:justify-evenly md:items-center">
        ...
        <div className="hidden md:block m-4 mt-10" onClick={onSubmit}>
          <ButtonPrimary text="Send Request" size="xl" />
        </div>
        <div className="block md:hidden m-3" onClick={onSubmit}>
